...
# and the seeded SQLite DB (copied to a writable location on first launch). Input
# DEMs are browsed from the user's filesystem at run time and are not bundled.
# resources/outputs is writable/runtime-generated and is NOT bundled; the empty
# app/resources dir and transient SQLite -wal/-shm files are also excluded.
datas = [('resources/about.jpg', 'resources'), ('app/data/db/app_data.db', 'app/data/db')]
binaries = []
