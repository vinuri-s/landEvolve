...
class SimulationResultsWindowConsts:
    ...
    TAB_TERRAIN_EVOLUTION = "Terrain Evolution (3D)"
    TAB_FLOW_ANIMATION = "Sediment Movement"
    TAB_ANALYSIS = "Analysis"
    TAB_FEATURE_TRACKING = "Feature Tracking"
    LBL_TIMELINE_NOT_AVAILABLE = "Erosion timeline not available for this simulation."
    LBL_TERRAIN_EVOLUTION_NOT_AVAILABLE = "Terrain evolution animation not available for this simulation."
    LBL_FLOW_ANIMATION_NOT_AVAILABLE = "Sediment flow animation not available for this simulation."
